...
(defun grafik (f% xmin xmax w Ttl) 
         ...
         L0     (setq y (f% x))
                ...
                (grwCreate w 400 400 Ttl &HFFFFFF)
                ...
                (for i 1 10 ((grwPrint w zx y (format y "0.00") &H000000) (setq y (- y dy dy))))
...
(grafik 'ff -20 20 'w1 "Первая функция")

(gcd)

(grafik 'gg -20 20 'w2 "Вторая функция")
