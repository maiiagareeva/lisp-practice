...
(defun grafik (f% g% xmin xmax w Ttl) 
         ...
         L2     (setq y (g% x))
          ...
          L6     (cond ((<> (sysMode) 3) (return 'ok)))

                 //(grwShow w 'kbd (\ (- (sysMetrics 0) 600) 2)  (\ (- (sysMetrics 1) 700) 2))
...
(grafik (function ch) (function sh) -5 5 'w-2 "Гиперболический синус и косинус")
